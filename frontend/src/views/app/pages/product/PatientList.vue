<template>
  <b-card class="mb-4" no-body v-if="!loading">
    <b-tabs v-if="!isPatient" card no-fade>
      ...
      <b-tab title="Register Patient" title-item-class="w-50 text-center">
        <label class="form-group has-top-label">
        ...
        <label class="form-group has-top-label">
          <input class="form-control" v-model="registerForm.gender" />
          <span>Gender</span>
        </label>
        <label class="form-group has-top-label">
          <input class="form-control" v-model="registerForm.dob" />
          <span>DOB</span>
        </label>
        <label class="form-group has-top-label">
          <input class="form-control" v-model="registerForm.bloodGroup" />
...
export default {
  ...
  methods: {
    async registerPatient() {
      const result = await window.contract.methods.addPatient(this.registerForm.name, this.registerForm.phone, this.registerForm.gender, this.registerForm.dob, this.registerForm.bloodGroup, this.registerForm.address).send({
