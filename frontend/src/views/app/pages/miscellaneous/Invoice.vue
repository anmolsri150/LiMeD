...
<div>
  ...
  <b-row>
    <b-colxx xxs="12">
        <b-card class="mb-4" no-body>
           <b-card-body>{{ $t('pages.invoice-info') }}</b-card-body>
        </b-card>
    </b-colxx>
  </b-row>
  <b-row>
    <b-colxx xxs="12" class="mb-3">
        <h3>{{ $t('pages.vue-version') }}</h3>
    </b-colxx>
  </b-row>
  ...
  <b-row>
    <b-colxx xxs="12" class="mb-3">
        <h3>{{ $t('pages.inline-version') }}</h3>
    </b-colxx>
  </b-row>

  <b-row class="invoice">
    <b-colxx xxs="12" class="mb-4">
        <div class="invoice-contents" style="background-color:#ffffff; height:1200px; max-width:830px; font-family: Helvetica,Arial,sans-serif !important; position: relative;">
